...
export default function NetflixPage() {
    ...
    const [movies, setMovies] = useState([
        {
            ...
            img_url : "http://asset-a.grid.id/crop/0x0:0x0/x/photo/2018/07/31/2984177993.jpg"
        },
        {
            title: "Bullet Train", 
            match : "87%", 
            ...
            img_url : "https://occ-0-6708-64.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABfybx8sO9Ah50hAiyoEWh1ljO_Hi4-ZXdlhnteko2QioGZ--fCB6nKYejBZsSYdPtX-nEaDp6CAW9cC8IwO9Qm5_3WsH3pn0Dyf4.jpg?r=2e3"
        ...
        },
        {
            ...
            category : "Science, Fiction, Horror, Drama Television, Series",
            img_url : "https://occ-0-6708-64.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABXY2VvgJN2P86Vds0Rmz1ShqYndn8xTgsRUy0fT970Rj9QBpECgS9hkBSMJQvexrzAG-vf-Zfo9oOOoQhvzYEzjToC4X6DlLRhai.jpg?r=f31"
        ...
        },
        {
            ...
            img_url : "https://occ-0-6708-64.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABSYDBj7An0dAh34eMsLsSZ_JjF08zVpMK5Xb3M5FcJSuMB0lzi2u-lbGR5wMj5x8UXd0kUJLIKKUBcrlINTD3pUwXtACKqT3gqJt.jpg?r=309"
        ...
        },
        {
            ...
            category : "Action, Adventure",
            img_url : "https://occ-0-6708-64.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABertyWsaSQhIfC4nvbk1DUUWqIR9UNkXkB_vW6q0N1an2EIjr1zlJ2j-oasB4xl8A7-KOJEHn-Lckz49MPkYJPhSZQ4Hozt0zzJO.jpg?r=4f1"
        ...
        },
        {
            ...
            category : "Action, Adventure",
            img_url : "https://occ-0-6708-64.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABQu9mse0lSb9MtIXnowfBtmd6q_g_5bdhpYWNxFjVNF76JyhXUZudM5h7rZG3eIP_m9acUlTRss79HUoxXlTxtYf_6JfKJE6g9if.jpg?r=590"
        ...
        },
        {
            ...
            category : "Action, Adventure",
            img_url : "https://occ-0-6708-64.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABbPXSGkNDo3cQ2rBKviUt71o_aPhcLPIcfsm8c8d2E2xEiu8qcLlAkPdMGyf6qqVK7kunauLQe9n1saLPSD6fjq-YYtIuKNcMbtO.jpg?r=d7f"
   ...
   async function showForm() {
      ...
      function addproductItem() {
        if(movies.find((val)=> val.title === newData.title)) return alert("you already add this Movie")
    ...
    return (
      ...
      <div className="navbar-logo"> NETFLIX</div>
        <div className="navbar-text">
            ...
            <div className="navbar-box2" onClick={showForm}>JOIN NOW</div>
            <div  className="navbar-box3" onClick={showForm}> SIGN IN</div>
        </div>
        </div>
        ...
        <button className="button-add-product"   onClick={addproductItem}>Add Movie </button>
         </div>
